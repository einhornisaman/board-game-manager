        ...
        if ($total > 0) {
            ...
            if (!empty($game_ids)) {
                ...
                foreach ($batches as $batch) {
                    ...
                    $thing_xml = @simplexml_load_file($thing_url);
                ...
                // Now format the final results
                foreach ($temp_results as $result) {
                    $bgg_search_results[] = $result;
                }
            }
        }
...
<head>
    ...
    <style>
        ...
        /* New styles for thumbnail display */
        .thumbnail-cell {
            width: 110px;
            text-align: center;
                                ...
                                <tr>
                                    <td class="thumbnail-cell">
                                        <?php if (!empty($game['thumbnail'])): ?>
                                            <img src="<?php echo htmlspecialchars($game['thumbnail']); ?>" alt="<?php echo htmlspecialchars($game['name']); ?>" class="game-thumbnail">
                                        <?php else: ?>
